  ...
  ({ slug, frontmatter, onChange, locale }) => {
    ...
    return (
      <>
        ...
        <article
          className={cn(PostStyles.article, frontmatter.theme)}
        >
          <main className={PostStyles.main}>
            <MDXProvider
              components={{
                ...
                p: (props) => (
                  <p className="text-type-p mt-1 " {...props} />
                ),
                h1: (props) => (
                  <h1 className="text-type-h1 mt-2" {...props} />
                ),
                h2: (props) => (
                  <h1 className="text-type-h2 mt-2" {...props} />
                ),
                h3: (props) => (
                  <h3 className="text-type-h3" {...props} />
                ),
...
export async function getStaticProps({
  ...
  const file = fs
    .readFileSync(`data/posts/${locale}/${slug}.mdx`)
    .toString();
